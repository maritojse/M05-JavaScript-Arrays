...
function multiplicarArgumentos() {
   ...
   console.log(multiplicarArgumentos(2, 3, 4)); // Output: 24
   console.log(multiplicarArgumentos(5)); // Output: 5
   console.log(multiplicarArgumentos()); // Output: 0
...
var resultado = continueStatement(0);
